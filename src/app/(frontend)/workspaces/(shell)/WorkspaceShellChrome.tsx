...
const GROUPS: SidebarGroup[] = [
  {
    ...
    sections: [
      ...
      },
      {
        label: 'Sports',
        icon: Dumbbell,
        href: '/workspaces/event-admin/sports',
        roles: ['super_admin', 'event_admin'],
      },
      {
        label: 'Categories',
        icon: Shapes,
        href: '/workspaces/event-admin/categories',
        roles: ['super_admin', 'event_admin'],
      },
      {
        label: 'Rulesets',
    ...
    sections: [
      {
        ...
        roles: ['super_admin', 'event_admin', 'draw'],
      },
      {
        label: 'Participants',
        icon: Users,
      ...
      },
      {
        ...
        roles: ['super_admin', 'event_admin', 'registration'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        roles: ['super_admin', 'event_admin', 'scheduler', 'draw'],
      },
      {
        label: 'Analytics',
        icon: Activity,
