  ...
  matches: [
    {
      ...
      participantA: 'Andi Pratama',
      participantB: 'Budi Santoso',
      scheduled_start_at: '2026-08-17T02:00:00.000Z',
      scheduled_end_at: '2026-08-17T03:00:00.000Z',
      venueName: 'Main Hall',
      courtName: 'Court 1',
      status: 'published',
      is_public: true,
    ...
    },
    {
      ...
      scheduled_start_at: '2026-08-17T03:30:00.000Z',
      scheduled_end_at: '2026-08-17T04:30:00.000Z',
      venueName: 'Main Hall',
      courtName: 'Court 2',
      status: 'published',
      is_public: true,
    ...
    {
      match_number: 'ROC-FUT-GA-002',
      round_name: 'Group A Match 2',
      sportSlug: 'roc-olympic-2026-futsal',
      categorySlug: 'roc-olympic-2026-futsal-men',
      stageCategorySlug: 'roc-olympic-2026-futsal-men',
      groupName: 'Group A',
      participantA: 'HR Club',
      participantB: 'TBD Futsal Opponent',
      scheduled_start_at: '2026-08-19T08:00:00.000Z',
      scheduled_end_at: '2026-08-19T09:00:00.000Z',
      venueName: 'Futsal Field',
      courtName: 'Futsal Field',
      status: 'scheduled',
      is_public: false,
  ...
  matchGeneration: [
    {
      ...
      matchNumberPrefix: 'ROC-BMS-GEN-R1',
      startNumber: 1,
      sportSlug: 'roc-olympic-2026-badminton',
      categorySlug: 'roc-olympic-2026-badminton-men-single',
      stageCategorySlug: 'roc-olympic-2026-badminton-men-single',
  ...
  matchSets: [
    {
      ...
      notes: 'Seeded placeholder set for score input validation.',
    },
    {
