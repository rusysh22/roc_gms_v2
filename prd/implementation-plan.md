...
- [ ] Match detail public page.
- [ ] Match detail admin panel.
- [ ] Score input.
...
- [ ] Add group standing public view.
...
- [ ] Public can read standings on mobile.
